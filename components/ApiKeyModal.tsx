    ...
    >
      ...
      >
        ...
        <p className="text-slate-300 mb-4 text-sm">
          Para utilizar el analizador necesitas una clave API de Google Gemini. Puedes crearla gratis para un uso educativo desde Google AI Studio. Esta clave se guardará únicamente en tu navegador.
        </p>
        ...
        <p className="text-xs text-slate-500 mt-3">
          Tu clave nunca se envía a nuestros servidores. Se guarda en localStorage para que puedas usar la app sin volver a introducirla.
        </p>
